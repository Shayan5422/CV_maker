      ...
      <div class="bg-white py-8 px-4 shadow-xl sm:rounded-xl sm:px-10 space-y-6">
          ...
          <div>
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                [ngClass]="{
                  'border-red-500': emailInput.invalid && emailInput.touched,
                  'border-gray-300': !emailInput.invalid || !emailInput.touched
                }"
          ...
          <div>
            ...
            <div class="mt-1 relative rounded-md shadow-sm">
              ...
              <input
                ...
                class="block w-full pl-10 pr-3 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                [ngClass]="{
                  'border-red-500': passwordInput.invalid && passwordInput.touched,
                  'border-gray-300': !passwordInput.invalid || !passwordInput.touched
                }"
                placeholder="••••••••"
              >
            </div>
        ...
        <div class="mt-6">
          ...
          <div class="mt-6 grid grid-cols-2 gap-3">
            <button
              type="button"
              class="w-full flex justify-center items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors"
            >
